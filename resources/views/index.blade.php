          ...
          <ul class="collapsible collapsible-accordion">
            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-tachometer-alt"></i>
              ...
              <div class="collapsible-body">
                <ul>
                  <li><a href="../html/dashboards/v-1.html" class="waves-effect">Version 1</a>
                  </li>
                  <li><a href="../html/dashboards/v-2.html" class="waves-effect">Version 2</a>
                  </li>
                  <li><a href="../html/dashboards/v-3.html" class="waves-effect">Version 3</a>
                  </li>
                  <li><a href="../html/dashboards/v-4.html" class="waves-effect">Version 4</a>
                  </li>
                  <li><a href="../html/dashboards/v-5.html" class="waves-effect">Version 5</a>
                  </li>
                  <li><a href="../html/dashboards/v-6.html" class="waves-effect">Version 6</a>
                  </li>
                </ul>
              </div>
            </li>
            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-image"></i> Pages<i class="fas fa-angle-down rotate-icon"></i></a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="../html/pages/login.html" class="waves-effect">Login</a>
                  </li>
                  <li><a href="../html/pages/register.html" class="waves-effect">Register</a>
                  </li>
                  <li><a href="../html/pages/pricing.html" class="waves-effect">Pricing</a>
                  </li>
                  <li><a href="../html/pages/about.html" class="waves-effect">About us</a>
                  </li>
                  <li><a href="../html/pages/single.html" class="waves-effect">Single post</a>
                  </li>
                  <li><a href="../html/pages/post.html" class="waves-effect">Post listing</a>
                  </li>
                  <li><a href="../html/pages/landing.html" class="waves-effect">Landing page</a>
                  </li>
                  <li><a href="../html/pages/customers.html" class="waves-effect">Customers</a>
                  </li>
                  <li><a href="../html/pages/invoice.html" class="waves-effect">Invoice</a>
                  </li>
                  <li><a href="../html/pages/page-creator.html" class="waves-effect">Page Creator</a>
                  </li>
                  <li><a href="../html/pages/support.html" class="waves-effect">Support</a>
                  </li>
                  <li><a href="../html/pages/chat.html" class="waves-effect">Chat</a>
                  </li>
                </ul>
              </div>
            </li>
