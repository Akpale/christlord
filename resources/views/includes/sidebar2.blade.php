      ...
      <ul class="custom-scrollbar">
        ...
        <li>
          <ul class="collapsible collapsible-accordion mt-0">
            <li><a class="text-white bg mt-2" href="{{route('membres.index')}}" class="collapsible-header waves-effect arrow-r">
            ...
            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-users"></i>
              ...
              <div class="collapsible-body">
                <ul>
                  <li><a href="{{route('membres.create')}}" class="waves-effect">Ajouter</a>
                  </li>
                  <li><a href="{{route('membre.show')}}" class="waves-effect">Mise à jour</a>
                  </li>
                </ul>
              </div>
            </li>
