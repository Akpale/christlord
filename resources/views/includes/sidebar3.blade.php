      ...
      <ul class="custom-scrollbar">
        ...
        <li>
          <ul class="collapsible collapsible-accordion mt-0">
            <li><a class="text-white bg mt-2" href="{{route('mem.index')}}" class="collapsible-header waves-effect arrow-r">
            ...
            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-users"></i>
                <span id="menu">Membres</span><i class="fas fa-angle-down rotate-icon"></i></a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="{{route('mem.create')}}" class="waves-effect">Ajouter</a>
                  </li>
                  <li><a href="{{route('mem.show')}}" class="waves-effect">Mise à jour</a>
                  </li>
                </ul>
              </div>
            </li>
            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-file-word"></i>
                <span id="menu">Programme d'activité</span><i class="fas fa-angle-down rotate-icon"></i></a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="{{route('fichiers.create')}}" class="waves-effect">Ajouter</a>
                  </li>
                  <li><a href="{{route('fichier.show')}}" class="waves-effect">Mise à jour</a>
                  </li>
                </ul>
              </div>
            </li>
