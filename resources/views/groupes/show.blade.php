 ...
 @section('content')
  ...
  <div class="card col-md-12">
    ...
    <div class="container-fluid" >
      ...
      @if(session('success'))
       ...
       <button type="button" onclick="location.href='{{route('groupes.create')}}'" class="btn btn-info"><i class="fas fa-plus-circle"></i> Ajouter</button>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{route('groupes.edit',$fichier->id)}}"><button><i class="far fa-edit"></i></button></a>
        
        <form action="" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet Membre ?')">
