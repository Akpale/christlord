 ...
 @section('content')
  ...
  <div class="card col-md-12">
    ...
    <div class="container-fluid" >
      ...
      <div align="center"><h2 class="text-muted"><u><b>Les Membres </b></u></h2></div> 
      ...
      @if(session('success'))
       ...
       <button type="button" onclick="location.href='{{route('mem.create')}}'" class="btn btn-info"><i class="fas fa-plus-circle"></i> Ajouter</button>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{route('mem.edit',$membres->id)}}"><button><i class="far fa-edit"></i></button></a>
        
        <form action="{{route('mem.destroy',$membres->id)}}" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet Membre ?')">
